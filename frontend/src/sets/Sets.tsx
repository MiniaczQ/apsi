...
export const Sets: FunctionComponent<DocumentsProps> = ({ apiClient }) => {
  ...
  const navigateToSetCreator = () => navigate('/setversions/new');
  const navigateToConcreteCreator = () => navigate('/setversions/new?documentSetId=48fee941-4ff7-4a44-b58e-8a3cde0feb53&parentVersionId=5a34316c-6851-4310-9c11-7912a08feaf7');
  const navigateToConcreteEditor = () => navigate('/setversions/edit?documentSetId=48fee941-4ff7-4a44-b58e-8a3cde0feb53&setVersionId=5a34316c-6851-4310-9c11-7912a08feaf7');
  ...
  return (
    <Container>
      ...
      <p>
        <Button variant="outline-primary" onClick={navigateToSetCreator}>
          Create Set
        </Button>
        <Button variant="outline-primary" onClick={navigateToConcreteCreator}>
          ConcreteVersionCreator
        </Button>
        <Button variant="outline-primary" onClick={navigateToConcreteEditor}>
          ConcreteEditor
        </Button>
      </p>
    </Container>
